...
目标模块包括：成员与项目、任务中心、持续执行、资料与成果、长期记忆、智能体能力库。详细范围和验收条件见[产品规划](docs/product-plan.md)；开发顺序见[路线图](docs/roadmap.md)。
...
甲发布一个智能体，乙在共享项目中独立使用；关闭页面后任务继续；成果与确认过的知识留存；下一次其他成员能接着用。代码检查通过只是基础工程证据，这个使用过程还需要真实任务验证。
