...
语义草案版本：v0.1-draft。日期：2026-09-21。B0 已落成[共享可执行契约 0.1.0](../../packages/contracts/README.md)，固定提交 `b2289595f2cdae5c5d0de0dfd3921f48d6670f87`；精确字段、接口和合成样例以该包为准。**B0 只有健康检查可调用，其余 API 仍待相应批次实施。** 下文保留原语义基线；前端从同一契约包消费，不另写状态模型。
